...
public class Notifikacija {
    ...
    public Notifikacija(String naslov, String tekst, String datum, String vrijeme) {
        this.naslov = naslov;
        this.tekst = tekst;
        this.datum = datum;
    ...
    public Notifikacija(String naslov, String tekst, String d, String t, Korisnik korisnik) {
        this.naslov = naslov;
        this.tekst = tekst;
        this.korisnik = korisnik;
        this.datum=d;
